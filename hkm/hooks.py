...
permission_query_conditions = {
    ...
    "HKM Voucher": "hkm.erpnext___custom.doctype.hkm_voucher.hkm_voucher_filter.list_filter",
}
has_permission = {
    "HKM Voucher": "hkm.erpnext___custom.doctype.hkm_voucher.hkm_voucher_filter.has_single_access",
}
